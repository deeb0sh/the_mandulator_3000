        ...
        <div v-if="showReg" class="modal">
            ...
            <div>
                <form @submit.prevent="setPostReg()">
                        <input class="txt" type="text" placeholder="Логин" v-model.trim="forms.reg.user" @input="regTouched=true">
                        <br>
                        <input class="txt" type="password" id="password" placeholder="Пароль" v-model.trim="forms.reg.password" @input="regTouched=true">
                        <input class="txt" type="password" id="confirmPassword" placeholder="Повторить пароль" v-model.trim="forms.reg.confirmPassword" @input="regTouched=true">
                        <br>
                        <input class="txt" type="text" placeholder="Инвайт код" v-model.trim="forms.reg.inCode" @input="regTouched=true">
                        <br>
                        <div align="center">
        ...
        <div v-else class="modal">
            ...
            <div>
                <form @submit.prevent="setPostLogin()">
                      <input class="txt" type="text" placeholder="Логин" v-model.trim="forms.login.user" @input="userTouched=true">
                      <input class="txt" type="password" placeholder="Пароль" v-model.trim="forms.login.passwd" @input="userTouched=true" autocomplete="no">
                      <br>
                      <div align="center">
